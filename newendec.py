...
#os.system(r"cartoon.exe")
print("Just For Security Purpose Answer a Question")
print("\n\n")


def Pet():
    print("Default Pet name is:0", "Please change this to your pet name for security Purpose!")
    petn = input("What is the name of your Pet:")
    li = len(petn)
    p = None
...
if x == 0:
    ...
    if l == 1:
        ...
        j.write('1')
        j.close()
        print("Default Password is 0 change this to your password,for security reasons you know very well!")
        pasn = input("Enter Your new password here:")
        li = len(pasn)
        while li != 0:
            for i in pasn:
                j = ord(i)
        ...
        if q == 1:
            a = input("Enter ur Pet name to verify it is u:")
            b = open(r"ans.txt", "r")
            v = b.read()
            os.system("cls")
            li=len(v)
            ...
            if str == a:
                ...
                pasnn = input("Enter Ur new Password here:")
                li = len(pasnn)
                while li != 0:
                    for i in pasnn:
                        j = ord(i)
...
def bashenc():
    ...
    t = {'A': 'Z', 'B': 'Y', 'C': 'X', 'D': 'W', 'E': 'V',
         ...
         'K': 'P', 'L': 'O', 'M': 'N', 'N': 'M', 'O': 'L',
         'P': 'K', 'Q': 'J', 'R': 'I', 'S': 'H', 'T': 'G',
         'U': 'F', 'V': 'E', 'W': 'D', 'X': 'C', 'Y': 'B', 'Z': 'A', '@': '@', ' ': ' ', '.': '.', 'a': 'z', 'b': 'y',
         'c': 'x', 'd': 'w', 'e': 'v',
         'f': 'u', 'g': 't', 'h': 's', 'i': 'r', 'j': 'q',
         'k': 'p', 'l': 'o', 'm': 'n', 'n': 'm', 'o': 'l',
         'p': 'k', 'q': 'j', 'r': 'i', 's': 'h', 't': 'g',
